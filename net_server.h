...
//-------------------------------------------------------------------------------云台控制命令。
#define PTZ_UP					0			//以ptzBit速度向上
#define PTZ_DOWN				1			//以ptzBit速度向下
#define PTZ_LEFT					2	    	 	 //以ptzBit速度向左
#define PTZ_RIGHT				3			//以ptzBit速度向右
#define PTZ_APERTURE_BIG		4  			//光圈调节，变大
#define PTZ_APERTURE_SMALL	       5			//光圈调节，缩小
#define PTZ_FOCUS_IN			6			//焦点前调
#define PTZ_FOCUS_OUT			7 			//焦点后调
#define PTZ_ZOOM_IN				8  			//焦距变大
#define PTZ_ZOOM_OUT			9			//焦距变小
...
#define PTZ_EX_LEFT_UP			20			// 左上方
#define PTZ_EX_LEFT_DOWN		21			// 左下方
#define PTZ_EX_RIGHT_UP		22			// 右上方
#define PTZ_EX_RIGHT_DOWN		23			// 右下方
...
typedef struct
{
	...
	char byHostAlmType;	// 报警类型，0-普通防区，1-紧急防区，
	char byRsv[2];			// 保留
	int dwAlarmID;		// 防区号
}SXC_ALARM_HOST_INFO;
...
typedef struct
{
	int byChannelID;		// 输入开关量 0-短路，1-开路
