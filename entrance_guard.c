...
entrance_guard_arg entrance_guard_data = {0, NO, NORMAL_OPEN, NORMAL_CLOSE, IS_OPENED, 0, 5, 5, 0, NO, NO, NO, 0, 0, {ENTRANCE_GUARD_SERIAL_PORT,0,0,0,{LINK_DEV_DOOR_CLT,1,DOOR_CTL_PROTOCOL_COSON},{ENTRANCE_GUARD_BOARD,ENTRANCE_GUARD_UART_DATA_BIT,ENTRANCE_GUARD_UART_STOP_BIT,ENTRANCE_GUARD_UART_CHECK_BIT,0}}};
...
int entrance_guard_handshake_and_setup(int *com_fd, FILE *fp_normal_message_file, FILE *fp_alarm_message_file, FILE *fp_message_count_file, FILE *fp_config_file)
{
    ...
    //entrance_guard_data.current_handshake_num = 248;
