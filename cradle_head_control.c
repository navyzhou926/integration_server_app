...
cradle_head_control_arg cradle_head_control_data = {0, CRADLE_HEAD_CONTROL_NO_VALID_COMMAND,CRADLE_HEAD_DEFAULT_PROTOCOL_TYPE,CRADLE_HEAD_DEFAULT_ADDRESS,CRADLE_HEAD_DEFAULT_MOVE_SPEED,CRADLE_HEAD_DEFAULT_PRESET_POINT,{CRADLE_HEAD_SERIAL_PORT,0,0,0,{LINK_DEV_CRADLE_HEAD,1,0},{CRADLE_HEAD_UART_BOARD,CRADLE_HEAD_UART_DATA_BIT,CRADLE_HEAD_UART_STOP_BIT,CRADLE_HEAD_UART_CHECK_BIT,0}}};
